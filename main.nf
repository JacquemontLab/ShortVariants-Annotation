...
workflow {
    ...
    main:
        ...
        // Extract gVCF paths, split into batches
        ...
        producetsv_files_ch = producetsv_ch.tsv_dir.flatten()
            .map { dir ->
                tuple(
                    dir.getName().replaceAll("batch_", "").replaceAll("_gvcf_produced", ""),
                    dir
                )
            }
